...
func GrantUserAccess(data LicenseData, appSecretKey string) (License, error) {
...
func GrantUserAccessAndSave(data LicenseData, appSecretKey, licenseFilePath string) error {
